...
select * from TABLE(KMEANSCOLORUDF(2,'CPU','COLORS'));
select * from TABLE(KMEANSCOLORUDF(2,'CPU','CSV:/home/db2inst1/workspace/db2CudaUDF/color17695.csv'));
...
select * from TABLE(KMEANSCOLORUDF(16,'CPU','COLORS'));
